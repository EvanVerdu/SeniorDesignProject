...
export const addSyllabus = async (syllabus) => {
    ...
    try {
      const response = await axios.post(
        "http://localhost:3001/syllabus/add",
...
export const findAllSyllabus = async() =>{
    ...
    await axios.post("http://localhost:3001/syllabus/findAll",
    {
        headers: {
            'Content-Type': 'application/json'
        }
...
export const findSyllabus = async(code) =>{
    let syllabusData = null;
    await axios.post("http://localhost:3001/syllabus/find", JSON.stringify(code),
    {
        headers: {
            'Content-Type': 'application/json'
        }
...
export const deleteSyllabus = async(code) =>{
    let status;
    await axios.post("http://localhost:3001/syllabus/delete", JSON.stringify(code),
    {
        headers: {
            'Content-Type': 'application/json'
        }
...
export const updateSyllabus = async (syllabus) => {
    try {
        const response = await axios.post(
        "http://localhost:3001/syllabus/updateSyllabus",
